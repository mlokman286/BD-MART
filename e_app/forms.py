...
class SignupForm(UserCreationForm):
    username=forms.CharField(label='Username',widget=forms.TextInput(attrs={'class':'w-full input','placeholder':'Username'}))
    password1=forms.CharField(label='New Password',widget=forms.PasswordInput(attrs={'class':'w-full input','placeholder':'Type a password'}))
...
class SigninForm(AuthenticationForm):
    username = forms.CharField(widget=forms.TextInput(attrs={"autofocus":True,'class':'w-full input','placeholder':'Type correct username'}))
